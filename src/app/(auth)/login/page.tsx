...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      toast({
        title: 'Mencoba Masuk dengan Google...',
        description: 'Silakan tunggu sebentar.',
      });
    } catch (error) {
      toast({
        variant: 'destructive',
        title: 'Oh tidak! Terjadi kesalahan.',
        description: 'Tidak dapat masuk dengan Google. Silakan coba lagi nanti.',
      });
    }
  };
  ...
  return (
    <Card className="mx-auto max-w-sm w-full shadow-lg">
      <CardHeader className="space-y-1 text-center">
        ...
        <CardDescription>
          Masukkan detail Anda untuk masuk ke akun UMKM Track
        </CardDescription>
      </CardHeader>
      <CardContent>
